...
const DetectionConfiguration: React.FC = () => {
	...
	const handleSubmit = async () => {
		...
		try {
			await axios.post(`${API_URL_LOCATION}/config/detection/update`, payload);
			setSnackbarStatus("success");
			setSnackbarMessage("Detection configuration saved successfully!");
			...
			setSnackbarMessage(`Failed to save config: ${errorDetail}`);
			setSnackbarOpen(true);
		}
	};
